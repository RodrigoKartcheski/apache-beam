...
mapping3 = [('custumers_id', 'STRING'), ('customers_unique_id', 'STRING'), ('zip_code', 'STRING'), ('price', 'float')]
mapping4 = [('custumers_id', 'STRING'), ('customers_unique_id', 'STRING'), ('zip_code', 'STRING'), ('price', 'float64')]
...
def string_to_float(element):
    ...
    if isinstance(value, str):
        value = value.strip("'")  # Remover as aspas se for uma string
    return {'price': str(float(value))}  # Converter para float e retornar como string
'''
